...
/**
 * main - To display information on the ELF header
...
/**
 * isELF - to check if afile is an ELF(binary?) file
...
/**
 * architecture - to print the architecture for a binary
...
/**
 * data_encoding - To print the data encoding of data in ELF
...
/**
 * version_num - to print the version num of the ELF spec
...
/**
 * os_abi - to print the OS and ABI to which ELF is targeted
 * @key: 8th byte of ELF file
 * Return: void
 */
void os_abi(int key)
{
...
/**
 * file_type - To identify and print the object file type
 * @key: Value of e_type in ELF file
 * Return: nothing
 */
void file_type(int key)
{
